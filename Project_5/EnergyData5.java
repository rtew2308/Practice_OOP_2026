 ...
 */
public class EnergyData5 implements Serializable {
    ...
    public EnergyData5(double mass, double velocity) {
        this.mass = mass;
    ...
    public String toString() {
        return "Mass=" + mass + ", Velocity=" + velocity + ", Energy=" + energy + ", Binary=" + binaryRepresentation;
    }
}